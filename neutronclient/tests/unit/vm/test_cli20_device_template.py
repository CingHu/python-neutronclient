...
class CLITestV20VmDeviceTemplateJSON(test_cli20.CLITestV20Base):
    _RESOURCE = 'device_template'
    _RESOURCES = 'device_templates'

    def setUp(self):
        plurals = {'device_templates': 'device_template'}
        super(CLITestV20VmDeviceTemplateJSON, self).setUp(plurals=plurals)
    ...
    def test_list_device_templates(self):
        cmd = device_template.ListDeviceTemplate(test_cli20.MyApp(sys.stdout),
                                                 None)
    ...
    def test_show_device_template_id(self):
        cmd = device_template.ShowDeviceTemplate(test_cli20.MyApp(sys.stdout),
                                                 None)
...
class CLITestV20VmDeviceTemplateXML(CLITestV20VmDeviceTemplateJSON):
    format = 'xml'
