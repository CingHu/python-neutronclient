...
class CLITestV20VmServiceInstanceJSON(test_cli20.CLITestV20Base):
    _RESOURCE = 'service_instance'
    _RESOURCES = 'service_instances'

    def setUp(self):
        plurals = {'service_instances': 'service_instance'}
        super(CLITestV20VmServiceInstanceJSON, self).setUp(plurals=plurals)
...
class CLITestV20VmServiceInstanceXML(CLITestV20VmServiceInstanceJSON):
    format = 'xml'
